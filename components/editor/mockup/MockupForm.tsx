    ...
    return (
        <div className="flex-1 flex items-center justify-center bg-background-primary rounded-md p-2">
            <div className="w-1/2 flex flex-col gap-2 items-center bg-background-light p-10 rounded-md">
              ...
              <p> OR </p>
              <button className="px-4 py-2 bg-primary-default text-white rounded-md text-sm relative cursor-pointer">Upload a screenshot <input type="file" name="user-image" onChange={changeMockupImage} className="absolute top-0 left-0 right-0 bottom-0 opacity-0 cursor-pointer"/></button>
            </div>
        </div>
    )
}
