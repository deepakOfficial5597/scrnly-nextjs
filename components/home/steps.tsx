const Steps = () => {
    return (
        <div className="flex flex-row justify-around rounded-lg bg-gray-100 px-10 py-10 border shadow-md border-gray-200">
            <div className="max-w-[30%] text-center py-10">
